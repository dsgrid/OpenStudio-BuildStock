...
# start the measure
class DRSetpointModificationCooling < OpenStudio::Measure::ModelMeasure
  # human readable name
  def name
    # Measure name should be the title case of the class name.
    return 'DR Setpoint Modification Cooling'
  end
...
DRSetpointModificationCooling.new.registerWithApplication
